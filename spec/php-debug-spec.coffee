...
describe "PhpDebug", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('php-debug')

  describe "when the php-debug:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'php-debug:toggleDebugging'
        expect(phpDebugPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'php-debug:toggleDebugging'
        expect(phpDebugElement).not.toBeVisible()
